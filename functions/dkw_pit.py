...
def plot_pit_with_dkw(u: np.ndarray,
                       alpha: float = 0.05,
    ...
    ax.step(grid, fn, where="post", label="CDF of PIT")
    ...
    ax.legend()
    ax.set_title(f"PIT with DKW band (n={len(u)}, α={alpha})")
    return ax
...
if __name__ == "__main__":
    ...
    plot_pit_with_dkw(u, alpha=0.05)
    plt.show()
